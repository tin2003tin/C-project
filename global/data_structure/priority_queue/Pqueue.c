...
void _t_Pqueue_fixUp(T_PQueue *pqueue)
{
    ...
    while (current_index != 0)
    {
        ...
        void *current = (char *)pqueue->queue.data + current_index * pqueue->queue.typeSize;
        void *parent = (char *)pqueue->queue.data + parent_index * pqueue->queue.typeSize;
...
void _t_Pqueue_fixDown(T_PQueue *pqueue)
{
    ...
    while (true)
    {
        ...
        void *current = (char *)pqueue->queue.data + current_index * pqueue->queue.typeSize;
        void *left_child = (char *)pqueue->queue.data + left_child_index * pqueue->queue.typeSize;
        void *right_child = (char *)pqueue->queue.data + right_child_index * pqueue->queue.typeSize;
        ...
        void *higher_child = (char *)pqueue->queue.data + higher_child_index * pqueue->queue.typeSize;
...
void t_Pqueue_display(const T_PQueue *pqueue, T_DisplayFunc displayFunc)
{
    ...
    {
        displayFunc((char *)pqueue->queue.first + i * pqueue->queue.typeSize);
    }
}